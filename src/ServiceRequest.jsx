const ServiceRequest = () => {
    return ( 
        <div className="w-full h-screen bg-blue-300">
            <div className="grid grid-cols-1 md:grid-cols-2 mx-auto md:mx-48">
                <div className="bg-green-500">
                    <div className="mt-5 flex flex-col px-10">
                         <label for="" className="font-semibold text-xl">Branch</label>
                    ...
                    <div className="mt-3">
                        <label for="" className="px-5 font-semibold text-xl">Requestor</label>
                ...
                <div className="bg-yellow-500">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-gray-500">
                        <div className="">
